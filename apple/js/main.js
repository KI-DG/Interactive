    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            case 0:
                ...
                let messageA_translateY_in = clacValuse(values.messageA_translateY_in, currentYOffst)
                let messageA_translateY_out = clacValuse(values.messageA_translateY_out, currentYOffst)
